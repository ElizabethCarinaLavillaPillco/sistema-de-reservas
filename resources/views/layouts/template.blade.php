...
<html lang="en">
    <head>
        ...
        <link href= "{{asset('admin_template/assets/css/styles.css')}}" rel="stylesheet" />
        <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
    </head>
    <body class="sb-nav-fixed"> 
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Expediciones Allinkay</a>
            <!-- Sidebar Toggle-->
        ...
        <script src="{{asset('admin_template/assets/js/datatables-simple-demo.js')}}"></script>
    </body>
</html>
